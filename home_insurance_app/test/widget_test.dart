...
void main() {
  ...
  testWidgets('Widget Test', (WidgetTester tester) async {
    ...
    //Show Policies page
    // Check whether thhe correct number of polcies is displayed on the screen .
    expect(
        find.byIcon(Icons.attach_money),
        findsNWidgets(CompanyPolicies.policies1
            .length)); // During the test pincode entered corresponds to policies1 list .
    //Check the working of buttons
    ...
    //Show Discounts Page
    // Check if the submit button takes back to homepage
