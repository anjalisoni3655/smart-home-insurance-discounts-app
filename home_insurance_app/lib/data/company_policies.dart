...
class CompanyPolicies{
  int pincode ;
  final List<Policy>policies1=[Policy("Tenant's Home Insurance",6,2000),
  ...
  final List<Policy>policies2=[Policy("Public Liability Coverage",6,5000),
                              Policy('Contents Insurance',6,3000),
                              Policy('Burglary and Theft',7,2000),
                              Policy('Home Structure Insurance',7,4000),
                              Policy("Loss In Natural Disaster",3,7000),
                              Policy("Landlord's Insurance",5,5000)];
  final List<Policy>policies3=[Policy("Standard Fire and Perils Policy",6,7000),
                              ...
                              Policy("Loss In Natural Disaster",3,4000),
                              Policy("Landlord's Insurance",5,5000)];
  final List<Policy>policies4=[Policy("Tenant's Home Insurance",6,2000),
