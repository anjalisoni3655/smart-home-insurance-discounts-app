...
class CompanyDataBase {
  ...
  static List<Offer> availableOffers = [
    new Offer({'${deviceName[DeviceType.SMOKE_CO_DETECTOR.index]}': 1, '${deviceName[DeviceType.THERMOSTAT.index]}': 1}, 5),
    new Offer({'${deviceName[DeviceType.THERMOSTAT.index]}': 1, '${deviceName[DeviceType.CAMERA.index]}': 1}, 4),
    new Offer({'${deviceName[DeviceType.DOORBELL.index]}': 2}, 3),
    new Offer({'${deviceName[DeviceType.THERMOSTAT.index]}': 1, '${deviceName[DeviceType.DOORBELL.index]}': 1}, 1),
