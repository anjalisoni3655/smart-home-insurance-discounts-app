...
class _ShowStructuresState extends State<ShowStructures> {
  int choosenIndex = 0; // Stores the index corresponding to the selected structure

  List<Mapping> choices = new List<Mapping>();
  @override
  void initState() {
    super.initState();
    userChoice = widget.structures[0]; // By default the first policy will be displayed as selected  .
