...
void main() {
  test('test 1: api logging in and logging out without throwing any exceptions', () async {
  ...
  test('test 6: api takes longer to respond on signOut request than set timeout', () async {
